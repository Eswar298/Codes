...
Nodes are indexed from 1 to N. Mario resides in node indexed P while Luigi lives in the node with index Q. It takes T amount of time to
travel 1 kilometre. Your task is to calculate the minimum time that it will take for Mario to go visit Luigi.
